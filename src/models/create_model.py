...
from src.models.constraints_tightening import create_est_tightening_constraints
...
def create_model_est(STN: dict, H: int) -> Any:
    ...
    create_est_parameters(model, STN, H)
    create_est_tightening_constraints(model, STN, H)
