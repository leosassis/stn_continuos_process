...
def create_model_f2_X_zero_est(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    ...
    formulation_name = "F2_X_0_EST"
    
    return model, formulation_name


def create_model_f3_YS_zero_est(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets YS to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F3_YS_0_EST"
    
    return model, formulation_name


def create_model_f4_ub_YS_task(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets YS to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F4_UB_YS_Task"
    
    return model, formulation_name


def create_model_f5_ub_YS_unit(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets YS to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F5_UB_YS_Unit"
    
    return model, formulation_name


def create_model_f6_ub_X_task(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    ...
    formulation_name = "F6_UB_X_Task"
    
    return model, formulation_name


def create_model_f7_ub_X_unit(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets X to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F7_UB_X_Unit"
    
    return model, formulation_name


def create_model_f8_ub_X_group_k(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets X to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F8_UB_X_Group_K"
    
    return model, formulation_name


def create_model_f9_ub_YS_group_k(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets X to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F9_UB_YS_Group_K"
    
    return model, formulation_name


def create_model_f10_X_YS_zero_est(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets YS to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F10_X_YS_0_EST"
    
    return model, formulation_name


def create_model_f11_ub_YS_task_unit(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets YS to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F11_UB_YS_Task_Unit"
...
def create_model_f12_ub_X_task_unit(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    ...
    formulation_name = "F12_UB_X_Task_Unit"
    
    return model, formulation_name


def create_model_f13_ub_X_YS_group_k(stn_data: dict, planning_horizon: int) -> tuple[ConcreteModel, str]:
    """
    Creates the base MILP model plus the constraint that sets X to 0 from n = 0 to n = est - 1.
    ...
    formulation_name = "F13_UB_X_YS_Group_K"
