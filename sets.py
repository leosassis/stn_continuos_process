...
def create_main_sets_parameters(model, STN, H):
    ...
    print(model.S_Time.data())
    print(model.S_Tasks.data())
    print(model.S_Units.data())
    print(model.S_Materials.data())
    print(model.S_J_Executing_I.data())
    print(model.S_I_In_J.data())    
    print(model.S_I_Continuos_Tasks.data())
    print(model.S_I_Production_Tasks.data())
    print(model.S_I_Consuming_K.data())
    print(model.S_I_Producing_K.data())
    print(model.S_K_Produced_I.data())
    print(model.S_K_Consumed_I.data())
    
    print(model.S_I_Production_Tasks_With_Transition.data())
    print(model.S_I_All_Transition_Tasks.data())
    print(model.S_I_Production_Tasks_Without_Transition.data())
    print(model.S_I_Direct_Transition_Tasks.data())
    print(model.S_I_Indirect_Transition_Tasks.data())
    print(model.S_I_Startup_Tasks.data())
    print(model.S_I_Shutdown_Tasks.data())
    print(model.S_I_Production_Tasks_With_Direct_Transition.data()) 
    print(model.S_I_Production_Tasks_With_Indirect_Transition.data())  
    
    print(model.S_J_Units_With_Direct_Transition_Tasks.data())
    print(model.S_J_Units_With_Shutdown_Tasks.data())
    print(model.S_J_Units_Without_Transition_Tasks.data())
    print(model.S_Raw_Materials.data())
    print(model.S_Final_Products.data())
    print(model.S_Intermediates.data()) 
