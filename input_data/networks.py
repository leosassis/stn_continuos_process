...
def define_stn_network_all_transitions(tau_factor: int, beta_factor: int, demand_factor: int, planning_horizon: int) -> dict:
    ...
    'UNIT_TASKS': {
        ...
        ('UC2', 'ITC1') : {'tau_min': 0, 'tau_max': 0, 'tau': 5, 'Bmin': 4, 'Bmax': 4, 'Cost': 6, 'vCost': 1, 'sCost': 25, 'direction': 1,},
        ...
        ('UC2', 'ITC2') : {'tau_min': 0, 'tau_max': 0, 'tau': 5, 'Bmin': 4, 'Bmax': 4, 'Cost': 6, 'vCost': 1, 'sCost': 25, 'direction': 1,},
