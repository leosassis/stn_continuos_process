...
def define_stn_network_1_nonuniform(tau_factor: int, beta_factor: int, demand_factor: int, planning_horizon: int) -> dict:
    """
    Create a process scheduling network (STN) based on the specified case.
...
def define_stn_network_1_nonuniform_utilities(tau_factor: int, beta_factor: int, demand_factor: int, planning_horizon: int) -> dict:
    """
    Create a process scheduling network (STN) based on the specified case.
    ...
    stn = {
        ...
        # Mapping of startup/shutdown transitions between tasks
        'TASKS_TRANSITION_TASKS': { 
            # Example: ('TC3', 'ITC3')   : {'isSU': True, 'isSD': False, 'isDirect': False, 'direction': 1,},
            
        },
        
        # Mapping of utilities used by tasks
        'TASKS_UTILITIES': { 
            # Example: ('TC5', 'O2')   : {'futil': 10, 'vutil': 0.25,},
            ('TC5', 'O2')   : {'futil': 10, 'vutil': 0.25,},
            ('TC6', 'O2')   : {'futil': 7, 'vutil': 0.50,},
            
        },
        
        'UNIT_TASKS' : {
            ('UA1', 'TA1'): {'tau_min': 4, 'tau_max': 6, 'tau': 1, 'Bmin': 25, 'Bmax': 30, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA2', 'TA2'): {'tau_min': 5, 'tau_max': 7, 'tau': 1, 'Bmin': 85, 'Bmax': 95, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA3', 'TB1'): {'tau_min': 5, 'tau_max': 7, 'tau': 1, 'Bmin': 40, 'Bmax': 60, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA4', 'TB2'): {'tau_min': 5, 'tau_max': 7, 'tau': 1, 'Bmin': 15, 'Bmax': 20, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA5', 'TB3'): {'tau_min': 8, 'tau_max': 10, 'tau': 1, 'Bmin': 90, 'Bmax': 95, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA5', 'TB4'): {'tau_min': 5, 'tau_max': 7, 'tau': 1, 'Bmin': 60, 'Bmax': 80, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA6', 'TC1'): {'tau_min': int(ceil(7 / tau_factor)), 'tau_max': 7, 'tau': 1, 'Bmin': 5, 'Bmax': 6 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA6', 'TC2'): {'tau_min': int(ceil(5 / tau_factor)), 'tau_max': 5, 'tau': 1, 'Bmin': 5, 'Bmax': 6 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA7', 'TC3'): {'tau_min': int(ceil(7 / tau_factor)), 'tau_max': 7, 'tau': 1, 'Bmin': 5, 'Bmax': 6 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA7', 'TC4'): {'tau_min': int(ceil(5 / tau_factor)), 'tau_max': 5, 'tau': 1, 'Bmin': 5, 'Bmax': 6 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA8', 'TC5'): {'tau_min': int(ceil(5 / tau_factor)), 'tau_max': 7, 'tau': 1, 'Bmin': 5, 'Bmax': 20 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            ('UA9', 'TC6'): {'tau_min': int(ceil(4 / tau_factor)), 'tau_max': 6, 'tau': 1, 'Bmin': 20, 'Bmax': 50 * beta_factor, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
        }      
    } 
