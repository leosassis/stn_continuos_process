...
def define_stn_network():
    ...
    STN = {
        ...
        'ST_ARCS': {
            ...
            ('RM', 'ITA3') : {'rho': -1.0, 'direction': -1},
            ('RM', 'TA3I') : {'rho': -1.0, 'direction': -1},
        ...
        'TS_ARCS': {
            ...
            ('ITA3', 'IA1') : {'rho': 1.0, 'direction': 1},
            ('TA3I', 'IA1') : {'rho': 1.0, 'direction': 1},
        ...
        'UNIT_TASKS': {
            #('UA1', 'TA1') : {'tau_min': 5, 'tau_max': 5, 'tau': 1, 'Bmin': 5, 'Bmax': 5, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            #('UA6', 'TA2') : {'tau_min': 5, 'tau_max': 5, 'tau': 1, 'Bmin': 3, 'Bmax': 3, 'Cost': 4, 'vCost': 1, 'sCost': 25, 'direction': 1,},
            
            ('UA2', 'TA3')  : {'tau_min': 5, 'tau_max': 5, 'tau': 1, 'Bmin': 3, 'Bmax': 3, 'Cost': 4, 'vCost': 1, 'sCost': 31.5, 'direction': 1,},
            ('UA2', 'ITA3') : {'tau_min': 0, 'tau_max': 0, 'tau': 2, 'Bmin': 4, 'Bmax': 4, 'Cost': 6, 'vCost': 1, 'sCost': 0, 'direction': 1,},
            ('UA2', 'TA3I') : {'tau_min': 0, 'tau_max': 0, 'tau': 1, 'Bmin': 3, 'Bmax': 2, 'Cost': 3, 'vCost': 1, 'sCost': 0, 'direction': -1,},
            
            ('UC5', 'TC1')  : {'tau_min': 5, 'tau_max': 5, 'tau': 1, 'Bmin': 3, 'Bmax': 3, 'Cost': 4, 'vCost': 1, 'sCost': 31.5, 'direction': 1,},
            ...
            ('UC5', 'TC2')  : {'tau_min': 5, 'tau_max': 5, 'tau': 1, 'Bmin': 3, 'Bmax': 3, 'Cost': 4, 'vCost': 1, 'sCost': 31.5, 'direction': 1,},
